...
How I start my llama.cpp instance:

```bash
➜ llama.cpp git:(master) llama serve \
    -m ~/.cache/huggingface/hub/models--unsloth--Qwen3.6-35B-A3B-MTP-GGUF/snapshots/5bc3e238d916f48a861bac2f8a1990a0e9b7e98d/Qwen3.6-35B-A3B-UD-Q5_K_XL.gguf                                                           \
